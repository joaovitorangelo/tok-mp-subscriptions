...
return array(
    ...
    'Tok\\MPSubscriptions\\Admin' => $baseDir . '/src/Admin.php',
    'Tok\\MPSubscriptions\\Core\\PostTypes\\CustomPostType' => $baseDir . '/src/Core/PostTypes/CustomPostType.php',
    'Tok\\MPSubscriptions\\Core\\PostTypes\\Plan' => $baseDir . '/src/Core/PostTypes/Plan.php',
    'Tok\\MPSubscriptions\\Core\\PostTypes\\Subscription' => $baseDir . '/src/Core/PostTypes/Subscription.php',
    'Tok\\MPSubscriptions\\Core\\PostTypes\\Taxonomy' => $baseDir . '/src/Core/PostTypes/Taxonomy.php',
    'Tok\\MPSubscriptions\\Core\\Security\\Crypto' => $baseDir . '/src/Core/Security/Crypto.php',
    'Tok\\MPSubscriptions\\Core\\Services\\MelhorEnvio' => $baseDir . '/src/Core/Services/MelhorEnvio.php',
    'Tok\\MPSubscriptions\\Core\\Services\\MercadoPago' => $baseDir . '/src/Core/Services/MercadoPago.php',
    'Tok\\MPSubscriptions\\Core\\Services\\Payloads\\MelhorEnvioPayloadBuilder' => $baseDir . '/src/Core/Services/Payloads/MelhorEnvioPayloadBuilder.php',
    'Tok\\MPSubscriptions\\Core\\Services\\Payloads\\MercadoPagoPlanPayloadBuilder' => $baseDir . '/src/Core/Services/Payloads/MercadoPagoPlanPayloadBuilder.php',
    'Tok\\MPSubscriptions\\Core\\Services\\Payloads\\PayloadBuilderFactory' => $baseDir . '/src/Core/Services/Payloads/PayloadBuilderFactory.php',
    'Tok\\MPSubscriptions\\Core\\Services\\Payloads\\PayloadBuilderInterface' => $baseDir . '/src/Core/Services/Payloads/PayloadBuilderInterface.php',
    'Tok\\MPSubscriptions\\Core\\Services\\ViaCep' => $baseDir . '/src/Core/Services/ViaCep.php',
    'Tok\\MPSubscriptions\\Frontend\\Ajax' => $baseDir . '/src/Frontend/Ajax.php',
    'Tok\\MPSubscriptions\\Frontend\\Forms' => $baseDir . '/src/Frontend/Forms.php',
    'Tok\\MPSubscriptions\\Frontend\\Handlers\\SubscriptionsPlanForm' => $baseDir . '/src/Frontend/Handlers/SubscriptionsPlanForm.php',
    'Tok\\MPSubscriptions\\Frontend\\Handlers\\WebhookHandler' => $baseDir . '/src/Frontend/Handlers/WebhookHandler.php',
    'Tok\\MPSubscriptions\\Infrastructure\\ErrorHandler' => $baseDir . '/src/Infrastructure/ErrorHandler.php',
    'Tok\\MPSubscriptions\\Infrastructure\\HttpClient' => $baseDir . '/src/Infrastructure/HttpClient.php',
    'Tok\\MPSubscriptions\\Plugin' => $baseDir . '/src/Plugin.php',
    'Tok\\MPSubscriptions\\SubscriptionManager' => $baseDir . '/src/SubscriptionManager.php',
);
